...
public class StudentManagement extends Person {

        Student[] students;
	
	public static void ShowInput(Student[] students) {
	...
	public void write(Student[] student) { 
        ...
        try {   
            FileOutputStream fo = new FileOutputStream("D:\\\\java_co_ban_ecl\\\\src\\\\LTHDT_3\\\\Student.txt");   // tao file f tro den student.dat
            ObjectOutputStream oStream = new ObjectOutputStream(fo); // dung de ghi theo Object vao file f
    ...
    public Student[] read() {
        ...
        try {   
            FileInputStream fi = new FileInputStream("D:\\java_co_ban_ecl\\src\\LTHDT_3\\Student.txt"); // tao file f tro den student.dat
            ObjectInputStream inStream = new ObjectInputStream(fi);  // dung de doc theo Object vao file f
